...
export default function HomeNavbar() {
  ...
  useEffect(() => {
    const fetchHamburgerMenus = async () => {
      try {
        const menuData =
          await client.fetch(`*[_type == "hamburgerMenu" && selectedPage->_type == "landingPage"]{
          _id,
          title,
          slug,
          url,
  ...
  const handleSearch = async (term) => {
    ...
    try {
      ...
      const bonusTypesResults = await client.fetch(bonusTypesQuery, {
        term: `*${q}*`,
      });
    ...
    <>
      <nav className="w-full flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-white sticky top-0 z-50 shadow-sm">
        ...
        <div className="flex items-center gap-0 md:gap-4 flex-1 justify-end">
          ...
          <div
            className="hidden md:flex items-center bg-[#F5F5F7] border border-[#E3E3E3] rounded-lg px-3 py-1 w-48 cursor-pointer"
          ...
          <div className="relative flag-dropdown">
            ...
            >
              <img
                ...
                alt={selectedFlag.name || selectedFlag.country}
                ...
                {countriesLoading
                  ...
                  : flags.map((flag) => (
                      ...
                      >
                        ...
                        {(selectedFlag.name || selectedFlag.country) ===
                          (flag.name || flag.country) && (
                          <svg
                            width="20"
                            height="20"
            ...
            <div className="relative">
              ...
              {brieflyOpen && (
                <div className="mt-2 space-y-2">
                  <Link
                    href="/briefly"
                    className="block pl-6 hover:underline text-gray-800 text-base font-medium font-['General_Sans']"
                  >
                    Blog
                  </Link>
                  <Link
        ...
        >
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-4 pb-8">
            <div className="flex items-center gap-2 md:gap-4 mb-6">
              ...
              <button
                className="ml-2 md:ml-4 text-gray-500 text-sm md:text-base font-medium hover:underline  flex-shrink-0"
                onClick={() => {
                  setSearchOpen(false);
                  setSearchValue("");
                  setSearchResults([]);
            ...
            <div>
              {searchLoading && (
                <div className="text-center text-gray-400 font-['General_Sans']">
                  Searching...
                </div>
              )}
              {searchError && (
                <div className="text-center text-red-500 font-['General_Sans']">
                  {searchError}
                </div>
              )}
              {!searchLoading &&
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 md:gap-4">
                          ...
                          <div>
                            {item._type === "offers" ? (
                              ...
                              <>
                                <div className="font-semibold text-gray-900 text-base group-hover:text-green-600 transition-colors font-['General_Sans']">
                                  {getItemTitle()}
                                </div>
                                <div className="text-sm text-gray-500 mt-1 font-['General_Sans']">
                                  {getItemDescription()}
                        ...
                        <div className="flex flex-col items-end mt-4 md:mt-0">
                          ...
                          <span className="text-xs text-gray-400 capitalize font-['General_Sans']">
                            {item._type}
                          </span>
                        </div>
                      </div>
              ...
              {!searchLoading && !searchError && !searchValue && (
                <div className="mb-6">
                  <div className="text-gray-500 text-sm mb-2 font-medium font-['General_Sans']">
                    Popular Searches
                  </div>
